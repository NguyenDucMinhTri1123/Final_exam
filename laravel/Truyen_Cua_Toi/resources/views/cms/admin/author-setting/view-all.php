                ...
                <table id="myTable" class="table table-striped dataTable no-footer" data-order="[[ 3, &quot;desc&quot; ]]" role="grid" aria-describedby="myTable_info">
                    <thead>
                        <tr role="row">
                            ...
                            <th class="la sorting" rowspan="1" colspan="1" style="width: 129px;">novels</th>
                    ...
                    <tbody>
                        ...
                        <tr role="row" class="odd">
                            ...
                            <td class="new_chap_at">3</td>
                            <td class="sorting_1">

                                <a href="admin?direct=author-manage&action=update" type="button" class="btn btn-warning btn-outline btn-circle btn-md m-r-5" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Sửa thông tin">
                                    <i class="far fa-edit"></i>
                                </a>

                                <a href="admin?direct=author-manage&action=delete" type="button" class="btn btn-danger btn-outline btn-circle btn-md m-r-5" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Cài đặt">
