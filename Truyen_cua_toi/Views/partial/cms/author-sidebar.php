    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="author?direct=novel-case" class="nav-link">
          ...
          <li class="nav-item">
            <a href="author?direct=notification" class="nav-link">
          ...
          <li class="nav-item">
            <a href="author?direct=setting" class="nav-link">
          ...
          <li class="nav-item">
            <a href="author?direct=create-novel" class="nav-link">
          ...
          <li class="nav-item">
            <a href="author?direct=my-novel" class="nav-link">
